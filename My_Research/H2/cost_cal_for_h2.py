...
#
# # 工厂生产成本
# class ProductionCostofPlant():
#     def __init__(self, number_of_operators = None, product_sale_cost = None, plant_overheads = None,
...
#                                      self.Plantoverheads() + self.Generalexpenses()
...
#                                        self.Operatingsupplies() + self.Laboratorycharges() + self.utilities
...
#
#     def Plantoverheads(self):
#         plant_overheads=
#         return plant_overheads
#
...
class OPEX:
    def __init__(self, electricityPrice, waterPrice, operatingLabor, utilities, maintenanceAndRepair,
                 operatingSupplies, laboratoryCharges, directSupervisoryAndClericalLabor, plantOverhead,
                 administrativeCosts, distributionAndSelling, tpc, fci):
        self.fci = fci
        self.tpc = tpc
        self.distributionAndSelling = distributionAndSelling
        self.administrativeCosts = administrativeCosts
        self.plantOverhead = plantOverhead
        self.directSupervisoryAndClericalLabor = directSupervisoryAndClericalLabor
        self.laboratoryCharges = laboratoryCharges
        self.operatingSupplies = operatingSupplies
        self.maintenanceAndRepair = maintenanceAndRepair
        self.utilities = utilities
        self.operatingLabor = operatingLabor
